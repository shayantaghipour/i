              ...
              <Flex flex={1} flexDir={"column"} px={10} display={{ base: "none", md: "flex" }}>
                ...
                <VStack w="full" alignItems={"start"} maxH={"350px"} overflowY={"auto"}>
                  ...
                  <Comment
                    createdAt="12h ago"
                    username="eminem"
                    profilePic="https://www.chipublib.org/wp-content/uploads/sites/3/2022/09/36079964425_7b3042d5e1_k.jpg"
                    text={"Nice pic"}
                  />

                  <Comment
                    createdAt={"3d ago"}
                    username={"michaeljacson"}
                    profilePic={"https://hips.hearstapps.com/hmg-prod/images/michael-jackson-performs-in-concert-circa-1986-news-photo-1680813884.jpg"}
